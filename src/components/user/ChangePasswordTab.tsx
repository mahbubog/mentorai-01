...
export function ChangePasswordTab() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      // Supabase handles password update using the current session token
      ...
      setMessage('Password updated successfully! You will need to log in again with the new password.');
      setNewPassword('');
      setConfirmPassword('');
  ...
  return (
    <div className="space-y-6">
      ...
      <form onSubmit={handleSubmit} className="space-y-6 max-w-lg">
        {/* Note: Supabase doesn't require current password if user is logged in via session */}
